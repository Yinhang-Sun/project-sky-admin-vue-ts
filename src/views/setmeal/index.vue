  ...
  <div class="dashboard-container">
    <div class="container">
      <div class="tableBar">
        ...
        <el-input v-model="name" placeholder="Please enter setmeal name" style="width: 15%" />
        ...
        <el-button type="primary" style="margin-left: 25px" @click="pageQuery()">Query</el-button>
        <div style="float:right">
          <el-button type="danger">Delete In Batches</el-button>
...
export default {
  ...
  methods: {
    ...
    handleStartOrStop(row) {
      ...
      this.$confirm('Confirm to adjust the sales status of the current setmeal, do you want to continue?', 'Prompt', {
